...
//             document.title = "Portfolio | TanvirAlam";
...
//     strings: ["Full Stack Web Development","Backend development","frontend development",  "Database management", "Version control and collaboration"],
//     loop: true,
//     typeSpeed: 50,
//     backSpeed: 25,
//     backDelay: 500,
...
$(document).ready(function () {
    ...
    // ===== Scroll, Load, ScrollSpy & Sticky Header =====
    $(window).on('scroll load', function () {
        $('#menu').removeClass('fa-times');
        $('.navbar').removeClass('nav-toggle');
...
document.onkeydown = function (e) {
    if (
        ...
        (e.ctrlKey && String.fromCharCode(e.keyCode) === 'U') // Ctrl+U
    ) {
        return false;
    }
};
